...
{"is_standalone":true,"refers_to_history":false,"prior_messages_needed":0,"needs_unseen_history":false,"reason":"<one sentence>","confidence":<0.0 to 1.0>}
...
- "confidence": a number between 0.0 and 1.0 reflecting how sure you are about the recommendation. 0.5 = default; 0.9+ = clear-cut.
...
- If the latest message is standalone, set "is_standalone": true, "refers_to_history": false, "prior_messages_needed": 0, and "needs_unseen_history": false. Do not pad genuinely standalone questions with unrelated prior messages.
...
- User: "What are the tradeoffs of SQLite and Postgres for an offline app?"
  Return: {"is_standalone":true,"refers_to_history":false,"prior_messages_needed":0,"needs_unseen_history":false,"reason":"The latest message can be handled without prior messages.","confidence":0.9}
- Earlier: "Here is the launch announcement draft."
  User: "Can you make that shorter?"
  Return: {"is_standalone":false,"refers_to_history":true,"prior_messages_needed":1,"needs_unseen_history":false,"reason":"The latest message refers to the announcement draft in the prior message.","confidence":0.9}
- Visible window (7 prior messages): msg -7 names the client ("We are working with Acme Corp on their renewal."); msgs -6 to -1 discuss tone preferences and template choices without naming the client again.
  ...
  Return: {"is_standalone":false,"refers_to_history":true,"prior_messages_needed":7,"needs_unseen_history":false,"reason":"The renewal references a client introduced 7 messages back; include the full window so the entity is preserved.","confidence":0.85}
- User: "Let's continue with the migration plan."
  Return: {"is_standalone":false,"refers_to_history":true,"prior_messages_needed":0,"needs_unseen_history":true,"reason":"The latest message depends on a migration plan that is not visible in the supplied window.","confidence":0.85}
- User: "Based on our earlier requirements, draft the final spec."
  Return: {"is_standalone":false,"refers_to_history":true,"prior_messages_needed":0,"needs_unseen_history":true,"reason":"The latest message invokes earlier requirements that are not visible in the supplied window.","confidence":0.9}
- User: "Schedule for Tuesday afternoon."
  Return: {"is_standalone":false,"refers_to_history":false,"prior_messages_needed":0,"needs_unseen_history":true,"reason":"The latest message lacks the event details needed to act on the schedule request.","confidence":0.8}
