...
- A number between 0.0 and 1.0 reflecting how sure you are about BOTH the execution_mode and the model_tier choice.
- 0.5 means default behavior with no strong signal either way; reserve 0.9+ for clear-cut cases.
- When either field is "unable_to_determine", confidence must be 0.5 or lower.
...
- User: "Look through this repo and tell me where auth is implemented."
  Return: {"execution_mode":"tool_assisted","model_tier":"local_strong","reason":"The request requires local file inspection and moderate code understanding.","confidence":0.85}
