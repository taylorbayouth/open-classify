// System prompt for the model specialization classifier. Picks the kind of
// model + prompt that should handle the request. Combined with the routing
// classifier's tier, this drives the aggregator's catalog lookup.
...
Examples:
- User: "What is DNS?"
  Return: {"model_specialization":"chat","reason":"The request is a general explanatory question.","confidence":0.95}
...
- User: "Extract the invoice number, vendor, and total as JSON only."
  Return: {"model_specialization":"instruction_following","reason":"The main task is structured extraction with strict output constraints.","confidence":0.95}
