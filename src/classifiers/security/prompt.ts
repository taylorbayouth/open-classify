...
- A number between 0.0 and 1.0 reflecting how sure you are about the risk_level + signals assessment.
...
- User: "Use this API key to test the integration."
  Return: {"risk_level":"suspicious","signals":["secret_or_private_data_risk"],"reason":"The request involves handling a credential.","confidence":0.85}
