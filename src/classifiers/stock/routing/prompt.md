...
Use local tiers for short, low-stakes, or self-contained requests where a small fast model is sufficient.
Use frontier tiers for high-stakes, ambiguous, multi-step, or complex requests.
Use *_coding tiers when the request is implementation-heavy.
