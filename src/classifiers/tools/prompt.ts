...
- A number between 0.0 and 1.0 reflecting how sure you are about the family selection (or absence).
...
- User: "Explain what DNS does."
  Return: {"needed":false,"families":[],"reason":"The request can be answered from general knowledge without tools.","confidence":0.9}
