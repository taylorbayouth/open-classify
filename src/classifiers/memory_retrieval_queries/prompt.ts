...
- A number between 0.0 and 1.0 reflecting how sure you are that the chosen queries are likely to surface useful memory.
...
- User: "What did we decide for the launch checklist?"
  Return: {"queries":["launch checklist prior decisions"],"reason":"Prior decisions are likely stored outside the visible request.","confidence":0.9}
- Earlier: "I have a meeting with Dave on Tuesday."
  User: "remind me at 3 PM"
  Return: {"queries":[],"reason":"The visible conversation supplies the needed reminder context.","confidence":0.8}
- Earlier: "I have a meeting with Dave on Tuesday."
