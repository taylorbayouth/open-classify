...
- Visible window (7 prior messages): msg -7 names the client ("We are working with Acme Corp on their renewal."); msgs -6 to -1 discuss tone preferences and template choices without naming the client again.
  ...
  Return: {"is_standalone":false,"refers_to_history":true,"prior_messages_needed":7,"needs_unseen_history":false,"reason":"The renewal references a client introduced 7 messages back; include the full window so the entity is preserved."}
